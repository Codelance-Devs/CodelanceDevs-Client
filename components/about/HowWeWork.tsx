...
const HowWeWork = () => {
	return (
		<>
			<div
				className='scroll-mt-24 grid px-3 py-16 md:px-5 lg:grid-cols-5 lg:px-[5vw] lg:py-[148px] w-full max-w-[1440px] mx-auto'
			>
				...
				{services.map((service, idx) => (
					<div key={idx} className='w-full px-[8px] py-4 md:p-1 '>
						<div className='group flex flex-col items-center h-full w-full select-none rounded-3xl px-[24px] py-10 md:px-4 md:py-14'>
