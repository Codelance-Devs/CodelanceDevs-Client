	...
	return (
		<>
			<div className='grid py-16 lg:grid-cols-5 lg:pb-[148px]'>
				<div className='col-span-2 flex flex-col items-center justify-start p-[8px] text-center md:col-span-3 md:p-4 lg:col-span-5'>
			...
			<div className='grid py-16 lg:grid-cols-6 lg:pb-[148px]'>
				<div className='col-span-2 flex flex-col items-center justify-start p-[8px] text-center md:col-span-4 md:p-4 lg:col-span-6'>
					<h1 className='mb-4 select-text text-[32px] font-medium text-[#23262f] md:text-[34px] lg:text-[40px]'>
						Technologies we use
					</h1>
					<p className='text-[18px] text-[#4c4f58]'>
