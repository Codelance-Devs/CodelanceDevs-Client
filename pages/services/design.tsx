                    ...
                    <section className="mx-auto flex w-full flex-col lg:flex-row lg:py-[148px]">
                        <div className="h-1/2 w-full p-2 md:py-5 md:px-4 lg:h-full lg:w-1/2 lg:p-4 ">
                            ...
                            <p className="mb-6 text-justify text-[14px] font-normal text-[#777a85] md:text-[16px]">
                                Elevate your online presence with our top-notch UI/UX design service. Our agency specializes in website, web app, and mobile app design, offering a wide range of services to meet all your needs. Our team creates wireframes, prototypes and layouts that are not only visually stunning, but also user-friendly and easy to navigate. Whether you&apos;re looking to revamp your website, or launch a new web or mobile app, our UI/UX design service will help you achieve your goals and exceed your expectations.
                            </p>
                            <div className="pt-5">
                                <Link href="/#getQuote">
                        ...
                        <div className="h-1/2 flex items-center justify-center w-full p-2 md:py-5 md:px-4 lg:h-full lg:w-1/2 lg:p-4 ">
                            <Image
                                src={Wireframing.src}
                                width={100}
                                height={100}
